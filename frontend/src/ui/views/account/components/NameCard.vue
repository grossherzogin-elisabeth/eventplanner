<template>
    ...
    >
        ...
        <template #edit="{ value }">
            ...
            <div class="mb-4">
                <VInputLabel>{{ $t('views.account.personal.display-name.label') }}</VInputLabel>
                <VInputText v-model="value.nickName" :placeholder="value.firstName" />
            </div>
            <div class="mb-4">
                <VInputLabel>{{ $t('views.account.personal.degree') }}</VInputLabel>
                <VInputText v-model="value.title" :placeholder="$t('generic.no-information')" disabled />
            </div>
            <div class="mb-4">
                <VInputLabel>{{ $t('views.account.personal.first-name') }}</VInputLabel>
                <VInputText v-model="value.firstName" required disabled />
            </div>
            <div class="mb-4">
                <VInputLabel>{{ $t('views.account.personal.middle-name') }}</VInputLabel>
                <VInputText v-model="value.secondName" :placeholder="$t('generic.no-information')" disabled />
            </div>
            <div class="mb-4">
                <VInputLabel>{{ $t('views.account.personal.last-name') }}</VInputLabel>

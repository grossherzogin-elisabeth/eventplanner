        ...
        <div class="px-8 py-8 md:px-16 xl:px-20">
            <div class="max-w-2xl">
                ...
                <p class="mb-8">
                    ...
                    >. Je detailierter du einen Fehler dabei beschreibst, desto leichter können wir ihn nachstellen und
                    beheben. Wenn du einen GitHub Account hast, kannst du zum Melden von Bugs auch direkt ein Ticket in
                    unserem
                    <a
                        class="link"
                ...
                <VInfo class="-mx-4 mb-8">
                    Viele Fehler lassen sich schon dadurch beheben, die Seite einmal neu zu laden und es noch einmal zu
                    probieren. Klicke dazu auf den Neu Laden Button <i class="fa-solid fa-rotate-right"></i>, den du
                    meistens oben links in deinem Browserfenster findest oder verwende die Tastenkombination
                    <code>STRG</code> + <code>R</code> (Windows) bzw. <code>CMD</code> + <code>R</code> (MacOS). Auf
                    mobilen Geräten kannst du die Seite nach unten ziehen, um sie neu zu laden.
                </VInfo>

    ...
    <div v-if="enableLoginView">
        ...
        <div class="fixed bottom-0 left-0 right-0 top-0 overflow-y-auto">
            <div class="mx-auto flex min-h-full flex-col justify-end sm:p-8">
                ...
                <div
                    class="bg-surface mx-auto flex w-full flex-col rounded-t-3xl sm:max-w-xl sm:rounded-3xl md:flex-row lg:max-w-5xl"
                >
                    <div class="relative hidden w-0 flex-grow overflow-hidden rounded-l-3xl lg:block">
                        ...
                        />
                        <div
                            class="from-p-50 absolute bottom-0 left-0 right-0 top-0 bg-gradient-to-l to-transparent"
                        ></div>
                    </div>
                ...
                <div class="bg-surface h-0 flex-grow sm:hidden"></div>
            </div>
        </div>
    </div>
    <div v-else class="h-full overflow-y-auto px-8 pb-8 pt-8 md:px-16 xl:px-20">
        <div
            class="bg-secondary-container text-onsecondary-container -mx-4 flex max-w-2xl items-center gap-4 rounded-2xl p-4"
        >

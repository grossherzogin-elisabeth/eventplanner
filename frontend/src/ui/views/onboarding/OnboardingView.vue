    ...
    <div class="flex h-full flex-1 flex-col xl:overflow-y-auto xl:overflow-x-hidden">
        <div class="px-8 pb-8 pt-8 md:px-16 xl:px-20">
            <div class="max-w-2xl">
                ...
                <p class="mb-4">
                    Um Zugriff auf die Daten der App zu erhalten, musst du ein Stammcrew Mitglied sein. Wir konnten
                    deinen Account allerdings keinem registrierten Stammcrew Mitglied zuordnen. Dies kann verschiedene
                    Gründe haben:
                </p>
                <ul class="mb-4 ml-4 list-disc space-y-2">
                    ...
                    <li>
                        Du hast bei der Registrierung deinen Namen etwas anders geschrieben (z.B. mit/ohne
                        Zwischennahmen, mit/ohne Bindestrich, ...)
                    </li>
                    <li>
                        Du bist dem Verein noch nicht beigetreten und bist deshalb noch nicht in unserer Datenbank
                        hinterlegt
                    </li>
                </ul>
                <section>
                    <VInfo class="my-8">
                        ...
                        <p class="mb-4 text-base">
                            Solltest du noch kein Vereinsmitglied sein, kannst du auf unserer Website einen
                            Mitgliedsantrag stellen. Du bekommst innerhalb einiger Werktage eine Bestätigung und kannst
                            die App dann vollumfänglich nutzen.
                        </p>
                ...
                <p class="mb-4">
                    Wenn du schon Vereinsmitglied bist und trotzdem diese Seite siehst, gab es vermutlich einen der oben
                    genannten Fehler bei deiner Registrierung. Bitte melde dich bei
                    <a :href="`mailto:${config.technicalSupportEmail}`" class="link">{{

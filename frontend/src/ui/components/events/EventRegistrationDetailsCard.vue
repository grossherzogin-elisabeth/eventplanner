<template>
    <section>
        ...
        <VInteractiveList>
            ...
            <RegistrationOvernightStayCard :model-value="props.registration" @update:model-value="saveRegistration($event)" />
            <RegistrationArrivalDateCard :model-value="props.registration" @update:model-value="saveRegistration($event)" />
        </VInteractiveList>
    </section>
</template>

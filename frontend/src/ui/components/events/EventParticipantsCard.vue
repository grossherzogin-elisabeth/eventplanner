<template>
    <div
        ...
        class="bg-surface-container/50 xs:-mx-4 -mx-2 rounded-2xl px-4 shadow-sm md:-mx-4 md:-mt-4 md:bg-transparent md:shadow-none"
    >
    ...
    <div v-else-if="hasHiddenCrewAssignments">
        <section>
            ...
            <div
                class="bg-surface-container/50 xs:-mx-4 -mx-2 rounded-2xl p-4 shadow-sm md:mx-0 md:rounded-none md:bg-transparent md:p-0 md:shadow-none"
            >
                <ul class="space-y-2">

<template>
    <div class="group relative -m-2 flex cursor-pointer items-start space-x-6 rounded-xl p-2 hover:bg-surface-container" @click="edit()">
...
import { type Dialog, VSheet } from '@/ui/components/common';
...
const editSheet = ref<Dialog<T, T | undefined> | null>(null);

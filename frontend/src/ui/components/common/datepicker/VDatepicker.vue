<template>
    <div ref="datepicker" class="v-datepicker max-w-full" @click.stop="" @mouseup.stop="">
        ...
        <div class="content pt-3">
            <div class="day-selection grid grid-cols-7 gap-y-2">
...
function onModelValueChanged(date?: Date): void {
    const visibleDate = cropToPrecision(date ?? props.highlightFrom ?? props.highlightTo ?? new Date(), 'days');
    year.value = visibleDate.getFullYear();
    month.value = visibleDate.getMonth();
}

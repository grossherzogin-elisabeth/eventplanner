...
<p>
    Deine Teilnahme an der Reise <b>${event.name}</b> vom <b>${event_start_date}</b> bis zum
    <b>${event_end_date}</b> wurde storniert. Du bist nun nicht mehr als Crew eingeplant.
</p>
<p>

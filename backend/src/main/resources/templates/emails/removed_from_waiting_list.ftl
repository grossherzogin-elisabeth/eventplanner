<span class="preheader">Du wurdest von der Warteliste für die Reise ${event.name} am ${event_start_date} entfernt.</span>
<table role="presentation" border="0" cellpadding="0" cellspacing="0" class="main">
    <tr>
        <td class="wrapper">
            ...
            <p>
                Du stehst jetzt nicht mehr auf der Warteliste für die Reise <b>${event.name}</b>
                vom <b>${event_start_date}</b> bis zum <b>${event_end_date}</b>.
            </p>
            <p>

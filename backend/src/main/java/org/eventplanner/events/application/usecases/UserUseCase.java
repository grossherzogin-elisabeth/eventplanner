...
public class UserUseCase {
    ...
    private void updateUserQualifications(
        ...
        addedQualifications.forEach(q -> notificationService.sendQualificationAddedNotification(user, q));
        removedQualifications.forEach(q -> notificationService.sendQualificationRemovedNotification(user, q));
        updatedQualifications.forEach(q -> notificationService.sendQualificationUpdatedNotification(user, q));
    }

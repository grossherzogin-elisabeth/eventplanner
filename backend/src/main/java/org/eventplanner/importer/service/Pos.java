...
public class Pos {
    protected static final PositionKey KAPITAEN = new PositionKey("kapitaen");
    protected static final PositionKey STM = new PositionKey("steuermann");
    protected static final PositionKey NOA = new PositionKey("noa");
    ...
    protected static final PositionKey BACKSCHAFT = new PositionKey("backschaft");
}
